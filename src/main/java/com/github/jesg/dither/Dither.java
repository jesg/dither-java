...
public class Dither {
    ...
    /**
     * Returns tests generated by the AETG strategy. No constraints are imposed, and no tests are
     * considered as previously tested. The coverage strength is {@code 2}.
     *
     * @param params the parameters
     * @return the tests
     *
     * @deprecated Use {@link #aetg(Object[][])} instead.
     */
    @Deprecated
    ...
    /**
     * Returns tests generated by the AETG strategy. No constraints are imposed, and no tests are
     * considered as previously tested.
     *
     * @param t the coverage strength
     * @param params the parameters
     * @return the tests
     *
     * @deprecated Use {@link #aetg(int, Object[][])} instead.
     */
    @Deprecated
    ...
    /**
     * Returns tests using the AETG strategy.
     *
     * @param t the coverage strength
     * @param seed the random seed, or null
     * @param params the parameters
     * @param constraints the constraints
     * @param previouslyTested the previously tested tests
     * @return the generated tests
     *
     * @deprecated USe {@link #aetg(int, Integer, Object[][], Integer[][], Object[][])} instead.
     */
    @Deprecated
    ...
    /**
     * Returns tests generated by the AETG strategy.
     *
     * @param t the coverage strength
     * @param seed the random seed, or null
     * @param params the parameters
     ...
     * @param params the parameters; each element must be an {@code Object[]}
     * @param constraints the constraints; each element must be an {@code Integer[]}
     * @param previouslyTested the previously tested tests; each element must be a {@code Object[]}
     * @return the generated tests
     *
     * @deprecated Use {@link #aetg(int, Integer, Object[], Object[], Object[])} instead.
     */
    @Deprecated
